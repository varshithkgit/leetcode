...
const AdminVideo = () => {
      ...
      const handleDelete = async (id) => {
        ...
        try {
          await axiosClient.delete(`/video/delMetaData/${id}`);
...
<div className="min-h-screen bg-gray-950 text-white py-10 px-4">
  <div className="max-w-7xl mx-auto">
    ...
    <div className="flex justify-between items-center mb-8">
      <h1 className="text-4xl font-extrabold tracking-tight">🎥 Video Upload and Delete</h1>
    </div>
              ...
              >
                ...
                <td className="px-6 py-4 flex space-x-2">
                  <NavLink
                    ...
                    className="flex items-center space-x-2 px-4 py-1.5 bg-blue-600 hover:bg-blue-500 text-white text-sm rounded-lg transition duration-200"
                  >
                    Upload
                  </NavLink>
                  <button
                    onClick={() => handleDelete(problem._id)}
                    className="px-4 py-1.5 bg-red-600 hover:bg-red-500 text-white text-sm rounded-lg transition duration-200"
                  >
                    Delete
                  </button>
                </td>
